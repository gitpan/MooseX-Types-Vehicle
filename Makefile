# This Makefile is for the MooseX::Types::Vehicle extension to perl.
#
...
#     ABSTRACT => q[Moose Types for Vehicles (NHSTA 17 char VIN)]
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[MooseX-Types-Vehicle]
#     LICENSE => q[perl]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/ecarroll/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKE = make
FULLEXT = MooseX/Types/Vehicle
BASEEXT = Vehicle
PARENT_NAME = MooseX::Types
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/MooseX/Types/Vehicle.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/MooseX/Types
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/MooseX/Types
...
TO_INST_PM = lib/MooseX/Types/Vehicle.pm

PM_TO_BLIB = lib/MooseX/Types/Vehicle.pm \
	blib/lib/MooseX/Types/Vehicle.pm
...
manifypods : pure_all  \
	lib/MooseX/Types/Vehicle.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/MooseX/Types/Vehicle.pm $(INST_MAN3DIR)/MooseX::Types::Vehicle.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Moose::" VERSION="2.06" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MooseX::Types" VERSION="0.35" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="MooseX::Types::Moose" VERSION="0.35" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/MooseX/Types/Vehicle.pm blib/lib/MooseX/Types/Vehicle.pm 
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Test::More,0,Moose,2.06,MooseX::Types,0.35,MooseX::Types::Moose,0.35

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Test::More,0,Moose,2.06,MooseX::Types,0.35,MooseX::Types::Moose,0.35

listdeps ::
	@$(PERL) -le "print for @ARGV" 

listalldeps ::
	@$(PERL) -le "print for @ARGV" Test::More Moose MooseX::Types MooseX::Types::Moose
